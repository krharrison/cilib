 ...
 */
public class WindowedFixedPoolSelectionIterationStrategy implements IterationStrategy<PSO>, SelfAdaptivePSOIterationStrategy {
    ...
    protected Map<Behaviour, List<Integer>> successCounters;
     ...
     * Default constructor.
     */
    public WindowedFixedPoolSelectionIterationStrategy() {
     ...
     */
    public WindowedFixedPoolSelectionIterationStrategy(WindowedFixedPoolSelectionIterationStrategy copy) {
     ...
     */
    @Override
    public WindowedFixedPoolSelectionIterationStrategy getClone() {
        return new WindowedFixedPoolSelectionIterationStrategy(this);
    }
