...
import cilib.functions.activation.ActivationFunction;
...
public class Neuron implements Cloneable {
     ...
     * @return the stored activation after the last call of {@link #calculateActivation(cilib.nn.architecture.NeuralInputSource). }
     */
