 ...
 *  \___/_/_/_/_.___/
 */
package cilib.entity.operators;
...
public interface Operator extends Cloneable {
    ...
    /**
     * Perform the operator operation given the current {@link cilib.entity.topologies.TopologyHolder}.
     *
     * @param holder The {@link cilib.entity.topologies.TopologyHolder} representing the required
     *               {@link cilib.entity.Topology} instances.
     */
