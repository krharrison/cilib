...
import cilib.io.transform.DataOperator;
import cilib.io.transform.DoNothingDataOperator;
...
/**
 * Abstract class represents an {@link cilib.problem.Problem} where the goal is to optimize
