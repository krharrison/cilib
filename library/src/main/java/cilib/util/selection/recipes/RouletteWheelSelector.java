...
import cilib.util.selection.arrangement.ProportionalArrangement;
import cilib.util.selection.arrangement.ReverseArrangement;
import cilib.util.selection.arrangement.SortedArrangement;
import cilib.util.selection.weighting.LinearWeighting;
import cilib.util.selection.weighting.Weighting;
